...
public class SystemUiU extends BaseModule {
    ...
    public void handleLoadPackage() {
        ...
        boolean isPixelBatteryStyle = !mPrefsMap.containsKey("prefs_key_system_ui_status_bar_battery_style_pixel") ||
                mPrefsMap.getBoolean("system_ui_status_bar_battery_style_pixel");
        initHook(BatteryStyle.INSTANCE, isPixelBatteryStyle ||
